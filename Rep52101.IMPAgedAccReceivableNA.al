report 52101 "IMP Aged Acc. Receivable NA"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Reports/IMPAgedAccountsReceivableNA.rdl';
    ApplicationArea = Basic, Suite;
    Caption = 'IMP Aged Accounts Receivables';
    ...
    begin
        ...
        ExcelBuf.AddColumn("Cust. Ledger Entry".FIELDCAPTION("Cust. Comments"), FALSE, '', TRUE, FALSE, TRUE, '', ExcelBuf."Cell Type"::Text);
    end;
    ...
    begin
        ...
        ExcelBuf.AddColumn("Cust. Ledger Entry"."Cust. Comments", FALSE, '', FALSE, FALSE, FALSE, '', ExcelBuf."Cell Type"::Text);
    end;
